...
//                                 onCancel={() => {
//                                     setShowForm(false); // Reset form visibility for creating a new task
...
//                                                 className="inline-flex items-center px-3 py-1 text-sm font-medium text-white bg-red-600 hover:bg-red-500 rounded-md"
//                                             >
//                                                 Delete
//                                             </button>
//                                         </div>
